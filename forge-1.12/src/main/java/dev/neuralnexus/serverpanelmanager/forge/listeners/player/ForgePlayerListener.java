...
public class ForgePlayerListener {
    ...
    public void onPlayerAdvancement(AdvancementEvent event) {
        ...
        if (display != null && display.shouldAnnounceToChat()) {
            ...
            SPMPlayerAdvancementListener.onPlayerAdvancement(new ForgePlayer(event.getEntityPlayer()), display.getTitle().toString());
        }
    }
    ...
    public void onPlayerDeath(LivingDeathEvent event) {
        ...
        SPMPlayerDeathListener.onPlayerDeath(new ForgePlayer((EntityPlayer) entity), event.getSource().getDeathMessage(entity).toString());
    }
    ...
    public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        SPMPlayerLoginListener.onPlayerLogin(new ForgePlayer(event.player));
    }
    ...
    public void onPlayerLogout(PlayerEvent.PlayerLoggedOutEvent event) {
        // Pass player to helper function
        SPMPlayerLogoutListener.onPlayerLogout(new ForgePlayer(event.player));
    }
